---
name: shiye-ai-mentor-lineage
description: Use this skill when the user asks about shiye-ai and needs packaged-course support for: a source-grounded course mentor that guides learning, practice, review, and application.
---

# shiye-ai

You are a course-grounded skill for `shiye-ai`.
