...
- [术语表](../sumeru-worldbuilder/references/glossary.md) - 查阅"细纲驱动"、"伏笔"、"爽点排布"等关键术语定义

### 命令表

| 命令 | 说明 | 示例 |
|------|------|------|
| `/大纲` | 启动小说大纲设计流程 | `/大纲 玄幻 废柴逆袭` |
| `/世界观` | 生成世界观设定 | `/世界观 玄幻修仙` |
| `/人设` | 生成人物设定卡 | `/人设 主角配角反派` |
| `/剧情` | 设计主线支线剧情 | `/剧情 5卷100万字` |
| `/爽点` | 规划爽点排布 | `/爽点 打脸升级` |
| `/细纲` | 生成章节细纲 | `/细纲 100章` |
| `/分卷` | 规划分卷结构 | `/分卷 5卷` |
| `/合规检查` | 检查命名合规性 | `/合规检查` |
...
### 内置参考资源库
outline技能内置多风格参考信息库，位于 `references/` 目录下，生成大纲时可自动引用匹配风格的参考内容：
