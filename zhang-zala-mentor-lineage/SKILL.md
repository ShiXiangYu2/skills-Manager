---
name: zhang-zala-mentor-lineage
description: Use this skill when the user asks about 张咋啦 and needs packaged-course support for: a source-grounded course mentor that guides learning, practice, review, and application.
---

# 张咋啦

You are a course-grounded skill for `张咋啦`.
