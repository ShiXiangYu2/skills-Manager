...
|------|------|------|
| `/润色` | 启动小说润色流程 | `/润色 轻度` |
| `/轻度润色` | 优化句式表达，精炼用词 | `/轻度润色` |
| `/中度润色` | 重构段落结构，提升文笔质感 | `/中度润色` |
| `/深度润色` | 逐字打磨，追求最佳阅读体验 | `/深度润色` |
| `/节奏收紧` | 删除无效铺垫，加快信息传递 | `/节奏收紧` |
| `/爽点强化` | 强化爽点排布，增强画面感 | `/爽点强化` |
| `/对话优化` | 优化对话真实感，添加潜台词 | `/对话优化` |
| `/文笔优化` | 精准用词，句式变化，感官描写 | `/文笔优化` |
| `/批量润色` | 批量润色多个章节 | `/批量润色 第1-10章` |
...
#### 相关文档
- [技能边界矩阵](../sumeru-worldbuilder/references/skill-boundary-matrix.md) - 理解本技能与 `sumeru-finalize` 的功能边界区别
- [术语表](../sumeru-worldbuilder/references/glossary.md) - 查阅"爽点"、"短剧感"、"读者偏好硬约束"等关键术语定义
